...
- Trạng thái: Done
- Thay đổi: tạo rule và mẫu handoff cho module ứng dụng/dashboard/reporting.
- Contract ảnh hưởng: Không.
- Kiểm thử: Không áp dụng.
- Bằng chứng rubric: `TASK.md`, `BRANCH_RULES.md`.
- Bàn giao cho: TV4.
- Việc tiếp theo/rủi ro: TV4 lấy nền từ `develop` sau khi TV1 merge; chỉ tích hợp report contract được TV2/TV3 xác nhận và lưu screenshot/evidence thật.
