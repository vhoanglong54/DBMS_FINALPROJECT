...
- Trạng thái: Done
- Thay đổi: tạo rule và mẫu handoff cho module class/booking/check-in.
- Contract ảnh hưởng: Không.
- Kiểm thử: Không áp dụng.
- Bằng chứng rubric: `TASK.md`, `BRANCH_RULES.md`.
- Bàn giao cho: TV3.
- Việc tiếp theo/rủi ro: TV3 đọc contract từ nhánh TV1/develop sau khi PR TV1 được merge; giữ evidence concurrency có thể tái tạo.
